<template>
  <div class="px-4 sm:px-0">
    <!-- Page Header -->
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-vue-dark mb-4">🔌 插件工具</h1>
      <p class="text-gray-600">
        精选的 Vue.js 插件和工具，扩展功能和提升开发体验
      </p>
    </div>
    ...
    <SearchBanner
      title="寻找实用的插件工具"
      placeholder="搜索插件工具..."
      :popular-tags="['VueUse', 'Vue I18n', 'Auto Import', 'Composables']"
      @search="handleSearch"
    />
    ...
    <div class="mb-6 flex justify-between items-center">
      <div class="text-sm text-gray-500">
        找到 {{ filteredResources.length }} 个插件
      </div>
    ...
    <div v-if="filteredResources.length === 0" class="text-center py-12">
      ...
      <h3 class="text-lg font-medium text-gray-900 mb-2">未找到匹配的插件</h3>
...
import { plugins } from '~/data/resources'
...
const pluginCategories = computed(() => {
  ...
  return [
    { id: 'all', name: '全部', count: pluginCount },
    { id: 'composables', name: 'Composables', count: pluginCount },
  ]
})
