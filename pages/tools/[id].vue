...
// SEO Meta 配置
useSeoMeta({
  title: () => resource.value ? `${resource.value.name} - Vue.js 开发工具详情 | Vue Admin` : '资源未找到',
  ...
  ogType: 'article',
  ogUrl: () => resource.value ? `https://vueadmin.com/tools/${resource.value.id}` : '',
  ogImage: () => resource.value ? `https://vueadmin.com/tools/${resource.value.id}/preview.jpg` : '',
  ...
  twitterImage: () => resource.value ? `https://vueadmin.com/tools/${resource.value.id}/twitter.jpg` : ''
})
